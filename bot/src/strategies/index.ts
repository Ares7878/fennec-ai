...
export function createStrategy(name: string, config: StrategyConfig): BaseStrategy {
  switch (name) {
    ...
    default:
      throw new Error(`Stratégie inconnue : ${name}. Utilisez : rsi, macd, ema_cross, bollinger, consensus, adaptive, breakout`);
  }
}

export { ConsensusStrategy, AdaptiveStrategy, BreakoutStrategy };
